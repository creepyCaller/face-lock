package com.iflytek.wordlock.util;
...
public class CameraHelper {
	 ...
	 * @return 最大的size
	 * */
	private Size getMaxSize(List<Camera.Size> sizeList) {
	 ...
	 * @return 没找到则返回null
	 * */
	private Size getMaxFitSize(List<Camera.Size> sizeList, int screenWidth, int screenHeight) {
		CameraSizeComparator sizeComparator = new CameraSizeComparator();
		Collections.sort(sizeList, sizeComparator);// 拍照图片大小排序
	 ...
	 * 获取最适合屏幕分辨率的预览大小
	 * */
	public Size getFitPreviewSize(List<Camera.Size> previewlist,
			List<Camera.Size> picturelist, int screenWidth, int screenHeight) {
		CameraSizeComparator sizeComparator = new CameraSizeComparator();
		Collections.sort(previewlist, sizeComparator);// 预览大小排序从小到大
		Collections.sort(picturelist, sizeComparator);// 拍照图片大小排序

		List<Camera.Size> commonsize = new ArrayList<Camera.Size>();// 共同支持的分辨率
	 ...
	 * @return
	 */
	public Size getPreviewSize(List<Camera.Size> previewlist,
			List<Camera.Size> picturelist) {
		CameraSizeComparator sizeComparator = new CameraSizeComparator();
		Collections.sort(previewlist, sizeComparator);// 预览大小排序从小到大
