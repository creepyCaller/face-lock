package com.iflytek.wordlock.mixedverify;
...
import com.iflytek.wordlock.ListActivity;
import com.iflytek.wordlock.R;
import com.iflytek.wordlock.app.DemoApp;
import com.iflytek.wordlock.entity.User;
import com.iflytek.wordlock.ui.HintPopupWindow;
import com.iflytek.wordlock.util.CameraHelper;
import com.iflytek.wordlock.util.DensityUtil;

/**
 * 混合验证
 *
 * */
public class MixedVerifyActivity extends Activity implements Callback {
	...
	private IdentityListener mVerifyListener = new IdentityListener() {
		...
		public void onResult(IdentityResult result, boolean islast) {
			...
			try {
				...
				Intent intent = new Intent(MixedVerifyActivity.this, ListActivity.class);
